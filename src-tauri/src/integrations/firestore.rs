// SOT: firestore-integration, firestore-rest-api, google-service-account-jwt
...
pub async fn connect(_conn: &ResolvedConnection) -> AppResult<Arc<dyn Integration>> {
    Err(AppError::driver("Firestore adapter is not available in this build yet."))
}
